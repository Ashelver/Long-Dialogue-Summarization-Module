...
if __name__ == "__main__":
    ...
    tokenizer = BertTokenizer.from_pretrained('../models/icsi_tokenizer')

    outputs = []
    with tqdm(valid_data, desc=f"Generating summaries:") as progress_bar:
    ...
    with open("../results/icsi.json", "w", encoding="utf-8") as f:
